                ...
                <div className="hidden lg:flex lg:grow text-[hsl(0,0%,41%)] lg:items-center">
                    <div className="text-lg relative flex justify-end mr-6">
                        <div onMouseEnter={toggleDropdown1} onMouseLeave={handleMouseLeave} className="flex items-center hover:text-[hsl(0,0%,8%)]">
                            <span className="mr-2 cursor-pointer">Features</span>
                        ...
                        {isDropdownOpen1 && (
                            <ul className="absolute bg-white top-10 p-5 rounded-lg text-base drop-shadow-2xl">
                                <li className="flex items-center mb-2"><span className="mr-4"><IconTodo/></span><a href="" className="whitespace-nowrap">Todo List</a></li>
                                <li className="flex items-center mb-2"><span className="mr-4"><IconCalendar/></span><a href="">Calendar</a></li>
                                <li className="flex items-center mb-2"><span className="mr-4"><IconReminders/></span><a href="">Reminders</a></li>
                                <li className="flex items-center"><span className="mr-4"><IconPlanning/></span><a href="">Planning</a></li>
                            </ul>
                        )}
                    </div>
                    <div className="text-[hsl(0,0%,41%)] text-lg relative flex justify-start mr-6">
                        ...
                        {isDropdownOpen2 && (
                            <ul className="absolute bg-white top-10 p-5 rounded-lg text-base drop-shadow-2xl">
                                ...
                                <li className="mb-2"><a href="" className="whitespace-nowrap">Our Team</a></li>
                                <li><a href="">Blog</a></li>
                            </ul>
                        )}
                    </div>
                ...
                <div className="flex lg:hidden">
                    ...
                    <div className={`${sideBar} ${!isOpen ? ' -left-1/3 pointer-events-none' : ''}`}>
                        <div className="text-[hsl(0,0%,41%)] mt-20 text-lg">
                            ...
                            {isDropdownOpen1 && (
                                <ul className="p-5 text-lg">
                                    <li className="flex items-center mb-3"><span className="mr-4"><IconTodo/></span><a href="" className="whitespace-nowrap">Todo List</a></li>
                                    <li className="flex items-center mb-3"><span className="mr-4"><IconCalendar/></span><a href="">Calendar</a></li>
                                    <li className="flex items-center mb-3"><span className="mr-4"><IconReminders/></span><a href="">Reminders</a></li>
                                    <li className="flex items-center"><span className="mr-4"><IconPlanning/></span><a href="">Planning</a></li>
                                </ul>
                            )}
                        </div>
                        ...
                        <div className="text-[hsl(0,0%,41%)] mt-3 text-lg">
                            ...
                            {isDropdownOpen2 && (
                                <ul className="p-5 text-lg">
                                    <li className="mb-3"><a href="">History</a></li>
                                    <li className="mb-3"><a href="" className="whitespace-nowrap">Our Team</a></li>
                                    <li><a href="">Blog</a></li>
                                </ul>
                            )}
                        </div>
